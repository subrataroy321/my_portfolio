                ...
                <div className="container">
                    <div className="row mb-5 align-items-center">
                        ...
                        <div className="col-lg-5 pl-lg-5">
                            ...
                            <p className="lead" style={{color: 'white'}}>I am a creative-minded, solutions-driven full-stack software developer and passionate about building new ideas, bringing solutions to real life, I can build a front-end website to back-end CRUD. I have the learnability to explore new and I am motivated by the feedback of team mates.</p>
                            <p>
